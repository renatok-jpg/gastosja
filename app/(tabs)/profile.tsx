    ...
    return (
        ...
        >
            <View style={styles.content}>
                ...
                <View style={styles.card}>
                    <ListItem icon="shield-checkmark-outline" title="Privacidade & Segurança" />
                    <ListItem icon="help-circle-outline" title="Ajuda & Suporte" />
                    <ListItem icon="information-circle-outline" title="Sobre o GastosJá" value="v1.0.0" />
                </View>
                ...
                <View style={styles.card}>
                    <ListItem
                        ...
                        title="Limpar dados"
                        danger
                        showChevron={false} // Removendo a setinha conforme a imagem
